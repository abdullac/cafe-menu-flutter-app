...
List<DropdownMenuItem> dropDownMenuItems(PositionType? tableOrChair) {
  ...
  if (tableOrChair == null) {
    ...
    int count = tableOrChair == PositionType.table ? 8 : 40;
    for (int index = 0; index < count; index++) {
      if (index == 0) {
        ...
        dropDownItemList.add(
          DropdownMenuItem(
            value: tableOrChair == PositionType.table ? "T$index" : "C$index",
            child: Text("$index"),
          ),
        );
      }
